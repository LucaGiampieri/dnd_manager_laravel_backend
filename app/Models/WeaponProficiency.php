...
class WeaponProficiency extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        //e l'eventuale arma collegata direttamente
        static::saving(function (
            WeaponProficiency $proficiency
        ): void {
            //Una competenza specifica deve indicare una singola arma
            if (
                $proficiency->type === 'specific'
                && $proficiency->item_id === null
            ) {
                throw new InvalidArgumentException(
                    'Una competenza specifica deve indicare un’arma.'
                );
            }
    ...
    //Relazione molti-a-uno (BelongsTo):
    //una competenza specifica indica direttamente una singola arma
    ...
    //una categoria possiede molte assegnazioni di armi
    public function itemAssignments(): HasMany
    {
        return $this->hasMany(
            WeaponProficiencyItem::class
        );
    }
