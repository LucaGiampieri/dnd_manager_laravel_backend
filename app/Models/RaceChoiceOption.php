...
class RaceChoiceOption extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        static::saving(function (RaceChoiceOption $option) {
            ...
            if (
                ...
                throw new InvalidArgumentException(
                    'Il tipo dell’opzione razziale non è valido.'
                );
            }
            ...
            $choice = RaceChoice::query()
                ->find($option->race_choice_id);
    ...
    //ogni opzione appartiene a una scelta razziale
    public function raceChoice(): BelongsTo
    {
        return $this->belongsTo(RaceChoice::class);
    }
