...
class RaceChoice extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        static::saving(function (RaceChoice $choice) {
            ...
            if (
                ...
                throw new InvalidArgumentException(
                    'Il tipo della scelta razziale non è valido.'
                );
            }
            ...
            //Le scelte razziali non possono precedere il primo livello
            if ($choice->level < 1) {
                throw new InvalidArgumentException(
    ...
    //ogni scelta appartiene a una razza
    ...
    {
        return $this->hasMany(RaceChoiceOption::class)
            ->orderBy('sort_order');
    }
