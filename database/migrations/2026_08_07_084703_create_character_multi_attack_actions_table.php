    ...
    public function up(): void
    {
        Schema::create('character_multi_attack_actions', function (Blueprint $table) {
            ...
            $table->foreignId('character_multi_attack_sequence_id')
                ->constrained(table: 'character_multi_attack_sequences', indexName: 'fk_character_multi_attack_actions_character_multi_attac_0db8a4a4')
                ->cascadeOnDelete();
            ...
            $table->foreignId('character_weapon_attack_id')
                ->nullable()
                ->constrained(table: 'character_weapon_attacks', indexName: 'fk_character_multi_attack_actions_character_weapon_atta_3132b0b2')
                ->cascadeOnDelete();
