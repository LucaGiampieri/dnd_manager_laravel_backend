    ...
    public function up(): void
    {
        Schema::create('effect_definition_creature_type_modifiers', function (Blueprint $table) {
            ...
            $table->foreignId('effect_definition_id')
                ->constrained(table: 'effect_definitions', indexName: 'fk_effect_definition_creature_type_modifiers_effect_def_cd32ff5c')
                ->cascadeOnDelete();
            ...
            $table->foreignId('creature_type_id')
                ->constrained(table: 'creature_types', indexName: 'fk_effect_definition_creature_type_modifiers_creature_t_63a932bb')
                ->cascadeOnDelete();
