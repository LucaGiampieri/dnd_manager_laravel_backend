    ...
    public function up(): void
    {
        Schema::create('character_transformation_equipment_states', function (Blueprint $table) {
            ...
            $table->foreignId('character_transformation_id')
                ->constrained(table: 'character_transformations', indexName: 'fk_character_transformation_equipment_states_character__39b00b90')
                ->cascadeOnDelete();

            //Oggetto dell'inventario interessato
            $table->foreignId('character_inventory_instance_id')
                ->constrained(table: 'character_inventory_instances', indexName: 'fk_transformation_equipment_inventory_instance')
                ->cascadeOnDelete();
            ...
            $table->unique([
                ...
                'character_inventory_instance_id',
