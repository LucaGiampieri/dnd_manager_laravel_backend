...
return new class () extends Migration {
    ...
    {
        Schema::create('feat_saving_throw_proficiencies', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique([
                'feat_id',
                'ability_id',
            ], 'feat_saving_throw_proficiencies_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('feat_saving_throw_proficiencies');
    }
};
